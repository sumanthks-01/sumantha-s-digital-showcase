...
const HeroSection = () => {
  ...
  const springRotateX = useSpring(rotateX, { stiffness: 220, damping: 18, mass: 0.7 });
  const springRotateY = useSpring(rotateY, { stiffness: 220, damping: 18, mass: 0.7 });
  ...
  return (
    <section className="min-h-[80vh] flex flex-col md:flex-row items-center justify-between gap-12 mb-32">
      ...
      >
        ...
        <div className="tilt-container noselect" onMouseMove={handlePointerMove} onMouseLeave={resetTilt}>
          <motion.div
            id="tilt-card"
            style={
              shouldReduceMotion
